...
INSERT INTO COMMENT_TEST (COM_ID, MEM_ID, COMMENT_CREATED,COMMENT_CONTENT) VALUES ( 1, 'user2', SYSDATE, '댓글 테스트입니다.');

------------------------------------------------------------
-- DATA_TEST 샘플 데이터
------------------------------------------------------------

INSERT INTO DATA_TEST (MEM_ID,CHECK_DATE,DI1_DG,DI2_DG,DE1_DG,DI3_DG,HE_HP,HE_GLU,HE_HBA1C,HE_CHOL,HE_TG,HE_BMI,HE_WC,BS1_1,BD1_11,BD2_1,PA_AEROBIC, BE8_1,SEX,AGE,EDU,INCM,PREDICT)
VALUES ('user1',SYSDATE,1,0,0,0,1, 98.5,5.4,180.2,120.5, 23.45,82.1,1, 2, 3,150,8,1,25,4,3.5,0.1234);
